...
def contact():
    mess._show(title='Contact us',
               message="Please contact us on : 'anandanubhav1516@gmail.com")
...
message3 = tk.Label(window, text="Automatic Attendance System Using Face Recognition",
                    fg="white", bg="black", width=55, height=1, font=('comic', 29, ' bold '))
...
datef = tk.Label(frame4, text=day+"-"+mont[month]+"-"+year+"  |  ", fg="yellow",
                 bg="black", width=55, height=1, font=('comic', 22, ' bold '))
datef.pack(fill='both', expand=1)

clock = tk.Label(frame3, fg="yellow", bg="black", width=55,
...
lbl = tk.Label(frame2, text="Enter ID", width=20, height=1,
               fg="black", bg="#c79cff", font=('comic', 17, ' bold '))
lbl.place(x=80, y=55)
...
message = tk.Label(frame2, text="", bg="#c79cff", fg="black", width=39,
                   height=1, activebackground="#3ffc00", font=('comic', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance", width=20, fg="black",
                bg="#c79cff", height=1, font=('comic', 17, ' bold '))
